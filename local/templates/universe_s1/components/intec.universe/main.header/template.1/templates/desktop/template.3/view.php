                                ...
                                <div class="widget-contacts">
                                    ...
                                    <?php if ($arResult['EMAIL']['SHOW']['DESKTOP']) { ?>
                                        <div class="widget-email">
                                            ...
                                            <a href="mailto:<?= $arResult['EMAIL']['VALUE'] ?>" class="email widget-email-text">
                                                ...
                                                <div class="widget-phone-content-wrapper intec-grid intec-grid-o-vertical">
                                                    <?php if ($arResult['CONTACTS']['ADVANCED']) { ?>
                                                        <?php foreach ($arContact as $arContactItem) { ?>
                                                            <a href="tel:<?= $arContactItem['PHONE']['VALUE'] ?>" class="tel widget-phone-content-text-value intec-cl-text-hover">
                                            ...
                                            <?php if (!empty($arContacts)) { ?>
                                                <div class="widget-phone-content-popup" data-block-element="popup">
                                                    <div class="widget-phone-content-popup-wrapper scrollbar-inner">
                                                            ...
                                                            <?php foreach ($arContacts as $arContact) { ?>
                                                                <div class="widget-phone-content-popup-contacts">
                                                                    <?php if (!empty($arContact['PHONE'])) { ?>
                                                                        <a href="tel:<?= $arContact['PHONE']['VALUE'] ?>" class="tel widget-phone-content-popup-contact phone intec-cl-text-hover">
                                                                    ...
                                                                    <?php if (!empty($arContact['EMAIL'])) { ?>
                                                                        <a href="mailto:<?= $arContact['EMAIL'] ?>" class="email widget-phone-content-popup-contact email intec-cl-text-hover">
                                                                            <?= $arContact['EMAIL'] ?>
                                                                        </a>
                                                                    <?php } ?>
                                                                </div>
                                                        ...
                                                        <?php } else { ?>
                                                            <?php foreach ($arContacts as $arContact) { ?>
                                                                <a href="tel:<?= $arContact['VALUE'] ?>" class="tel widget-phone-content-popup-item intec-cl-text-hover">
