...
$arResult['DESCRIPTION'] = [
    'SHOW' => $arParams['DESCRIPTION_SHOW'] === 'N',
...
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $iStoreId = !empty($arItem['DATA']['STORE_ID']) ? $arItem['DATA']['STORE_ID'] : $arItem['ID'];

    if (!empty($arParams['DETAIL_URL'])) {
        $arItem['DATA']['LINK'] = StringHelper::replace($arParams['DETAIL_URL'], [
            '#SITE_DIR#' => SITE_DIR,
            '#ELEMENT_ID#' => $iStoreId,
            '#ID#' => $iStoreId,
            '#CODE#' => $arItem['CODE'],
        ...
        $arItem['DATA']['LINK'] = $arItem['DETAIL_PAGE_URL'];
    }
...
unset($arItem, $arSection, $iStoreId);
