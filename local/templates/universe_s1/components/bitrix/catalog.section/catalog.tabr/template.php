        ...
        ?>
            <?= Html::beginTag('div', [
                ...
                <div class="catalog-section-item-wrapper">
                    <div class="catalog-section-item-base" style='height:70px'>
                        <?= Html::beginTag('div', [
                            'class' => 'catalog-section-item-image-block',
                            'style' => 'padding-top:' . $arVisual['IMAGE']['ASPECT_RATIO'] . '%'
                        ]) ?>
                            <div class="catalog-section-item-image-wrap" style='height:70px'>
                                <?php $vImage($arItem) ?>
                            ...
                            <!--/noindex-->
                            <?/* if ($arItem['DATA']['DELAY']['USE'] || $arItem['DATA']['COMPARE']['USE']) { ?>
                                <!--noindex-->
                                <?php $vButtons($arItem) ?>
                                <!--/noindex-->
                            <?php }*/ ?>
                        ...
                        <div class="catalog-section-item-advanced">
                            ...
                            <?php if ($arItem['DATA']['PRICE']['SHOW']) {
                                ...
                                if (!empty($arItem['ITEM_PRICES']))
									...
									if ($v_p < $b_p) {
										echo "<span style=\"color:red;\"><s>".$b_p."</s>&nbsp;руб.</span>";
										}
									$vPrice($arPrice);
                            } ?>
