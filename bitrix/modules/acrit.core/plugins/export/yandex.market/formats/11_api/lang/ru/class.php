...
$MESS[$strLang.'EXTERNAL_REQUEST_CHECKBOX'] = 'Разрешить внешний запрос (для /stocks, и при схеме FBS - для /cart)';
	...
	Для правильной работы профиля рекомендуется выполнить следующие настройки:<br/><br/>
	1. В личном кабинете Яндекса («Настройки» - «Настройки API») укажите адрес, на который Яндекс будет отправлять запросы на сайт.<br/> 
	Например, <b>(Имя домена вашего сайта)/yandex_market/(номер компании)</b>/<br/>
	Номер компании возьмите из раздела настройки API - <b>"Настройка запросов к Маркету"</b>. Это код из восьми цифр.
	Т.е. если у вас идентификатор компании = 12312323, а доменное имя сайта dns-shop.ru, и сайт работает по https, то должно получиться следующее:<br/><br/>
	<b>https://dns-shop.ru/yandex_market/12312323/</b><br/><br/>
	2. В настройках профиля импорта заказов в адресе внешнего запроса впишите: <b>yandex_market/номер компании/</b><br/><br/>
	Например - <b>yandex_market/12312323/</b><br/><br/>
	3. В настройке профиля экспорта товаров в адресе внешнего запроса впишите: <b>/yandex_market/номер компании/(stocks|cart)</b><br/><br/>
	Например <b>/yandex_market/12312323/(stocks|cart)</b><br/><br/>
	Имя домена в этих настройках указывать не нужно.<br/>
	Обратите внимание, что в профиле экспорта в конце адреса не нужно ставить завершающего слэша, а в профиле заказов он должен быть.<br/>
	При этом Ваш сайт не должен пытаться добавить слеш к этому адресу - иначе функционал не будет работать.<br/>
	Работа профилей экспорта и импорта взаимосвязаны.<br/> 
	Следует иметь ввиду, что если у вас есть несколько компаний в яндексе, то для каждой компании необходимо создавать отдельные профили экспорта и импорта.<br/>
	Именно адрес запросов будет определяь к какому именно профилю будет обращаться Яндекс.
	Поэтому для точной идентификации адреса запроса, в адресе необходимо указывить номер идентификатора компании. <br/><br/>
...
$MESS[$strName.'videos'] = 'Видео';
	$MESS[$strHint.'videos'] = 'Ссылка (URL) на видео товара.<br/><br/>
	<span style="color:red"><b>Внимание!</b> Пока действует временное ограничение: ссылка может быть только одна.</span><br/><br/>
	Требования к ссылке:
	<ul>
		<li>Указывайте ссылку целиком, включая протокол http или https.</li>
		<li>Максимальная длина — 512 символов.</li>
		<li>Русские буквы в URL можно.</li>
		<li>Можно использовать прямые ссылки на видео и на Яндекс Диск. Ссылки на Яндекс Диске нужно копировать с помощью функции Поделиться. Относительные ссылки и ссылки на другие облачные хранилища — не работают.</li>
	</ul>
	Ссылки на видео должны быть постоянными. Нельзя использовать динамические ссылки, меняющиеся от выгрузки к выгрузке.<br/><br/>
	Если нужно заменить видео, выложите новое видео по новой ссылке, а ссылку на старое удалите. Если просто заменить видео по старой ссылке, оно не обновится.<br/><br/>
	<a href="https://yandex.ru/support/marketplace/assortment/fields/video.html" target="_blank">Требования к видео</a>
	';
