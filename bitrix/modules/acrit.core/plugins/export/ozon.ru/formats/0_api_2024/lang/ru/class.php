...
$MESS[$strName.'pdf_list'] = 'PDF-файлы';
	$MESS[$strHint.'pdf_list'] = 'Список pdf-файлов.<br/></br>
	<b>Внимание!</b> Один и тот же файл не должен быть указан одновременно в данном поле и в поле «Документ PDF», иначе это может стать причиной ошибки загрузки на стороне Ozon.';
...
$MESS[$strName.'category_id'] = 'ID типа товара';
	$MESS[$strHint.'category_id'] = 'Укажите здесь ID типа товара (в новой версии API не путать с со справочным ID категории - он более не используется).<br/><br/>
...
$MESS[$strLang.'ERROR_EMPTY_REQUIRED_FIELDS'] = 'Для товара [ID=#ELEMENT_ID#] [категория «#CATEGORY#»] не заполнены обязательные поля: #FIELDS#';
$MESS[$strLang.'ERROR_WRONG_DICTIONARY_VALUE'] = 'Для товара [ID=#ELEMENT_ID#] [категория «#CATEGORY#»] в атрибуте "#ATTRIBUTE#" указано некорректное значение #VALUE#. Проверьте значение по справочнику.';
