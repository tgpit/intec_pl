...
$MESS['ACRIT_ORDERS_PLUGIN_YANDEXMARKET_SETTINGS_EXTERNAL_REQUEST_URL_HINT'] = '
...
Поэтому для точной идентификации адреса запроса, в адресе необходимо указывить номер идентификатора компании. 
';
