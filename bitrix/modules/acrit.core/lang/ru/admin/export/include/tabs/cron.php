...
$MESS['ACRIT_EXP_CRON_TIMEWEB_NOTICE'] = '<b style="color:maroon">Внимание!</b> Вы используете хостинг Timeweb! Здесь имеется особенность настройки задач: при любом изменении задач планировщика через панель хостинга все ранее настроенные через модуль задачи удаляются. Поэтому, необходимо либо постоянно контролировать этот момент, либо настраивать только одним способом: если настраиваете через сайт, то не настраивать через хостинг, и наоборот.';
...
$MESS['ACRIT_EXP_SEND_TO_EMAIL'] = 'Автоматическая отправка файлов на почту';
	$MESS['ACRIT_EXP_SEND_TO_EMAIL_HINT'] = 'Данная опция позволяет включить отправку сгенерированных файлов на почту.';
