<?
// General
$MESS['ACRIT_EXP_PAGE_TITLE_DEFAULT'] = 'Управление профилями экспорта на торговые площадки';
...
$MESS['ACRIT_EXP_HEADER_EXTERNAL_ID'] = 'Внешний код';
...
// Context
$MESS['ACRIT_EXP_CONTEXT_PROFILE_GROUP'] = 'Перейти';
...
$MESS['ACRIT_EXP_TOOLBAR_GROUP'] = 'Добавить группу';
...
$MESS['ACRIT_EXP_GROUP_ERROR_DELETE'] = 'Ошибка при удалении профиля ID=#ID#';
	$MESS['ACRIT_EXP_GROUP_ERROR_DELETE_GROUP'] = 'Ошибка при удалении группы ID=#ID#';
$MESS['ACRIT_EXP_GROUP_ERROR_UPDATE'] = 'Ошибка при изменении профиля ID=#ID#';
	$MESS['ACRIT_EXP_GROUP_ERROR_UPDATE_GROUP'] = 'Ошибка при изменении группы ID=#ID#';
$MESS['ACRIT_EXP_GROUP_ERROR_UNLOCK'] = 'Ошибка при снятии блокировки профиля ID=#ID#';
$MESS['ACRIT_EXP_GROUP_ERROR_UNCRON'] = 'Ошибка отмены автозапуска профиля ID=#ID#';
$MESS['ACRIT_EXP_GROUP_MOVE_TO_GROUP'] = 'переместить в группу...';
	$MESS['ACRIT_EXP_GROUP_MOVE_TO_GROUP_ROOT'] = 'Верхний уровень';

// Filter
$MESS['ACRIT_EXP_FILTER_ID'] = 'ID профиля';
$MESS['ACRIT_EXP_FILTER_GROUP_ID'] = 'Группа';
	$MESS['ACRIT_EXP_FILTER_GROUP_ID_ANY'] = '(любой)';
	$MESS['ACRIT_EXP_FILTER_GROUP_ID_ROOT'] = '--- верхний уровень ---';
