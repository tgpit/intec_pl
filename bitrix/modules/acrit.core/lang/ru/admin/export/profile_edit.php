...
$MESS['ACRIT_EXP_MAX_INPUT_VARS_WARNING_TITLE'] = '<b>Внимание!</b> Для корректного сохранения формы значение PHP-параметра <code><b>max_input_vars</b></code> недостаточно большое (<span data-role="acrit_exp_max_input_vars_warning_value_current">#VALUE_CURRENT#</span>)';
$MESS['ACRIT_EXP_MAX_INPUT_VARS_WARNING_DETAILS'] = 'Необходимо значение не менее <span data-role="acrit_exp_max_input_vars_warning_value_target">0</span> (рекомендуем увеличить значение с запасом). Без этого сохранение настроек формы невозможно.';
...
$MESS['ACRIT_EXP_POPUP_CATEGORY_REDEFINITION_SELECT_NOTE'] = 'Показаны первые 100 найденных категорий.';
...
$MESS['ACRIT_EXP_COPY_SIMILAR_FIELD'] = 'Скопировать выбранное поле [#CODE#] "#NAME#" в другие поля с таким же названием?';
...
//
$MESS['ACRIT_EXP_UPDATE_CATEGORIES_UNAVAILABLE'] = 'Обновление категорий доступно только при активной лицензии модуля экспорта.<br/>Необходимо <a href="#LINK#" target="_blank">продлить лицензию модуля</a> для возможности обновления категорий.';
