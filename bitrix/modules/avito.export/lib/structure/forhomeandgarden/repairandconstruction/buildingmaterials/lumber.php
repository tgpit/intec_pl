...
class Lumber implements Structure\Category, Structure\CategoryLevel
{
	...
	public function dictionary() : Dictionary\Dictionary
    {
	    return new Dictionary\Compound(array_merge(
		    (new Structure\DictionaryFactory(self::getLocalePrefix()))->make([
			    'all' => [
				    'other_tags' => 'forhomeandgarden/buildingmaterials/lumber.xml',
			    ...
			    'LumberType-->LUMBER_TYPE_BOARD' => [ $this->constructDictionariesEdgeType() ],
		    ]),
